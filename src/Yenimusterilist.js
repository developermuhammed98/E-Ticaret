...
function Yenimusterilist() {
  const [kisilertablo, setKisilertablo] = useState([]);
  useEffect(() => {
    const fetchKisilertablo = async () => {
      try {
        const response = await axios.get(
          "https://private-f738ac-itoapi3.apiary-mock.com/kisilertablo"
        );
        setKisilertablo(response.data.Kisilertablolist); // JSON verisindeki "Cargos" dizisini state'e kaydediyoruz
      } catch (error) {
...
export default Yenimusterilist;
